...
/**
 * Provides the local service interface for Countries. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Abhishek
 * @see CountriesLocalServiceUtil
...
public interface CountriesLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CountriesLocalServiceUtil} to access the countries local service. Add custom service methods to {@link com.dynamic.service.impl.CountriesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
