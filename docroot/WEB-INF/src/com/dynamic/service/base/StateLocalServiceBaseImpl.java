...
import com.dynamic.service.StateLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dynamic.service.impl.StateLocalServiceImpl}.
 * </p>
 *
 * @author Abhishek
 * @see com.dynamic.service.impl.StateLocalServiceImpl
 * @see com.dynamic.service.StateLocalServiceUtil
 * @generated
 */
public abstract class StateLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements StateLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.dynamic.service.StateLocalServiceUtil} to access the state local service.
	 */
	...
	@Override
	public State addState(State state) throws SystemException {
		state.setNew(true);
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public State deleteState(State state) throws SystemException {
	...
	@Override
	public State fetchState(long stateId) throws SystemException {
	 ...
	 */
	@Override
	public State getState(long stateId) throws PortalException, SystemException {
	 ...
	 */
	@Override
	public List<State> getStates(int start, int end) throws SystemException {
	 ...
	 */
	@Override
	public int getStatesCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public State updateState(State state) throws SystemException {
		return statePersistence.update(state);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.dynamic.model.State",
			stateLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.dynamic.model.State");
	}
